        ...
        {/* Scenario 1: MCQ Options Stack */}
            ...
            <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="flex items-center gap-3 bg-[#f8fafc] border border-slate-200/60 rounded-xl px-4 py-3">
                        <input
                            type="radio"
                            name={`mcq-${id}`}
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                const txt = e.target.value;
                                setQuestion((prev) => ({...prev, options: prev.options.map((elem, index)=> (index === 0 ? txt : elem))}));
                            }}
                    ...
                    <div className="flex items-center gap-3 bg-[#f8fafc] border border-slate-200/60 rounded-xl px-4 py-3">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                const txt = e.target.value;
                                setQuestion((prev) => ({...prev, options: prev.options.map((elem, index)=> (index === 1 ? txt : elem))}));
                            }}
                            className="w-full bg-transparent text-sm text-slate-700 outline-none"
                        />
                    </div>
                    <div className="flex items-center gap-3 bg-[#f8fafc] border border-slate-200/60 rounded-xl px-4 py-3">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                const txt = e.target.value;
                                setQuestion((prev) => ({...prev, options: prev.options.map((elem, index)=> (index === 2 ? txt : elem))}));
                            }}
                            className="w-full bg-transparent text-sm text-slate-700 outline-none"
                        />
                    </div>
                    <div className="flex items-center gap-3 bg-[#f8fafc] border border-slate-200/60 rounded-xl px-4 py-3">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                const txt = e.target.value;
                                setQuestion((prev) => ({...prev, options: prev.options.map((elem, index)=> (index === 3 ? txt : elem))}));
                            }}
                            className="w-full bg-transparent text-sm text-slate-700 outline-none"
                        />
                    </div>
